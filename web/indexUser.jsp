<%-- 
    Document   : index
    Created on : Sep 30, 2022, 1:10:31 PM
    Author     : user
--%>
      ...
      <div class="header_container">
        <div class="header_content">
          <ul>
            ...
            <li>
                <a href="#"> ${sessionScope.LOGIN_USER.user_Fullname} <i class="fa fa-user"></i> </a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="owl-carousel owl-theme">
            <div class="product_item">
              <a href="#"
                ...
                />
                <h3>
                  Tổ Yến Sào Tinh Chế Thượng <br />
                  Hạng Song Ân Loại 50g
                </h3>
                <p>2.835.000 đ</p>
              </a>
            </div>
